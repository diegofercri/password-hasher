...
namespace PasswordHasher
{
    ...
    public class PerformanceMonitor
    {
        ...
        public void RunPerformanceTest()
        {
            ...
            Console.WriteLine("- Memory: 19 MB");
            Console.WriteLine("- Iterations: 2");
            Console.WriteLine("- Parallelism: 1");
            Console.WriteLine("- Salt Size: 128 bits");
            Console.WriteLine("- Hash Size: 256 bits\n");
